...
//   String? revisionNumber;
//   String? description;
//   List<String>? parentProduct;
//   List<String>? po;
//   String? orderQunatity;
//   String? childproductId;
//   List<String>? parentproductId;
//   List<String>? sodetailsId;
...
//     parentProduct = json['parent_product'].cast<String>();
//     po = json['po'].cast<String>();
//     orderQunatity = json['order_qunatity'];
//     childproductId = json['childproduct_id'];
//     parentproductId = json['parentproduct_id'].cast<String>();
//     sodetailsId = json['sodetails_id'].cast<String>();
//   }
...
//     data['parent_product'] = parentProduct;
//     data['po'] = po;
//     data['order_qunatity'] = orderQunatity;
//     data['childproduct_id'] = childproductId;
//     data['parentproduct_id'] = parentproductId;
//     data['sodetails_id'] = sodetailsId;
//     return data;
